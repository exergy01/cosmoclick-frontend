        ...
        <div style={{ width: '96%' }}>
          ...
          <div style={{
            ...
            <ul style={{ fontSize: '14px', paddingLeft: '22px' }}>
              <li><strong>Звёздные системы</strong>: Несколько систем, в каждой — свои дроны, астероиды, экономика. Прогресс — отдельно.</li>
              <li><strong>Дроны</strong>: автоматически добывают CCC, CS и даже TON, можно покупать и улучшать.</li>
              ...
              <li><strong>Задания</strong>: ежедневные, которые дают ССС, ускорения, ресурсы. Разовые - приносят игроку CS.</li>
