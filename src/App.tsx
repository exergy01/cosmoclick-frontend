...
import GalacticEmpireShop from './pages/games/galactic-empire/ShipShop';
...
const MANIFEST_URL = process.env.NODE_ENV === 'production'
  ...
  : 'http://localhost:5002/tonconnect-manifest.json';
  ...
  return (
    <Suspense fallback={
      ...
      <Routes>
        ...
        <Route path="/games/galactic-empire/shop" element={<GalacticEmpireShop />} />
      </Routes>
    </Suspense>
  );
};
